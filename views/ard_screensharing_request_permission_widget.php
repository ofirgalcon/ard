<div class="col-lg-4 col-md-6">
    <div class="card" id="ard_screensharing_request_permission-widget">
        <div id="ard_screensharing_request_permission-widget" class="card-header" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/ard/get_screensharing_request_permission', function( data ) {
        ...
        var panel = $('#ard_screensharing_request_permission-widget div.card-body'),
