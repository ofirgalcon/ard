<div class="col-lg-4 col-md-6">
    <div class="card" id="ard_directory_login-widget">
        <div id="ard_directory_login-widget" class="card-header" data-container="body">
            <i class="fa fa-sitemap"></i>
            <span data-i18n="ard.directory_login"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/ard/get_directory_login', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#ard_directory_login-widget div.card-body'),
